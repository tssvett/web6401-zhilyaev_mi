...
---
# Лабораторная работа №3 и 4: Изучение основ JS
...
# Лабораторная работа 5: Моковый сервис

- Данные в табличку подтягиваются из мок сервера
- Формы поумнели
- Добавлены подсказки

Запуск мокового сервера - 
```bash
mock-json-server lab5/db.json
